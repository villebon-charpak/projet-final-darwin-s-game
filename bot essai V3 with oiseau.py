# -*- coding: utf-8 -*-
"""
Created on Mon May 28 00:24:01 2018
...
def distance_next_pigeon(liste_map):
    i=3
    distance2=0
...
def choix_robot(Map):
    if posDino == 0:
        if poids_distance*distance_bis + poids_largeur_cactus*largeur_cactus + poids_distance2*distance2_bis < 1.3:
            return K_SPACE
        else:
            return 'nothing'
...
poids_distance2=(rdm.randint(0,1000))/1000
